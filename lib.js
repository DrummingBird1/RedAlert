...
(function (root, factory) {
  ...
  // Default public-shelter samples (overridden at runtime if SHELTERS_URL is set)
  const SHELTERS_DEFAULT = [{lat:32.085,lng:34.782,n:'מקלט דיזנגוף'},{lat:32.074,lng:34.778,n:'מקלט רוטשילד'},{lat:31.768,lng:35.214,n:'מקלט ירושלים'},{lat:32.794,lng:34.99,n:'מקלט חיפה'},{lat:31.253,lng:34.791,n:'מקלט ב״ש'},{lat:31.669,lng:34.574,n:'מקלט אשקלון'},{lat:31.524,lng:34.596,n:'מקלט שדרות'},{lat:31.801,lng:34.643,n:'מקלט אשדוד'},{lat:32.07,lng:34.825,n:'מקלט רמת גן'},{lat:32.322,lng:34.853,n:'מקלט נתניה'},{lat:31.897,lng:35.01,n:'מקלט מודיעין'},{lat:31.973,lng:34.793,n:'מקלט ראשל״צ'}];

  // i18n strings (he/en/ar/ru). Hebrew is the fallback for any missing key.
  const LN = {he:{rockets:'ירי רקטות',uav:'כלי טיס עוין',earthquake:'רעידת אדמה',tsunami:'צונאמי',imm:'מיד',sec:'שניות',min:'דקות',minSingle:'דקה',active:'פעיל',km:'ק״מ',remaining:'נותרו',passed:'עבר',allClear:'הכל שקט',noAlerts:'אין אזעקות',noResults:'אין תוצאות',more:'עוד',now:'עכשיו',todayL:'היום',yesterdayL:'אתמול',weekAvg:'ממוצע',ttsPrefix:'צבע אדום ב',unknownLoc:'מיקום לא ידוע'},en:{rockets:'Rockets',uav:'UAV',earthquake:'Earthquake',tsunami:'Tsunami',imm:'Now',sec:'s',min:'min',minSingle:'min',active:'Active',km:'km',remaining:'left',passed:'done',allClear:'All Clear',noAlerts:'No alerts',noResults:'No results',more:'More',now:'Now',todayL:'Today',yesterdayL:'Yesterday',weekAvg:'Avg',ttsPrefix:'Red alert in ',unknownLoc:'Unknown location'},ar:{rockets:'صواريخ',uav:'طائرة',earthquake:'زلزال',tsunami:'تسونامي',imm:'فوراً',sec:'ث',min:'د',minSingle:'د',active:'نشط',km:'كم',remaining:'متبقي',passed:'انتهى',allClear:'هادئ',noAlerts:'لا إنذارات',noResults:'لا نتائج',more:'المزيد',now:'الآن',todayL:'اليوم',yesterdayL:'أمس',weekAvg:'متوسط',ttsPrefix:'إنذار أحمر في ',unknownLoc:'موقع غير معروف'},ru:{rockets:'Ракеты',uav:'БПЛА',earthquake:'Землетрясение',tsunami:'Цунами',imm:'Сейчас',sec:'с',min:'мин',minSingle:'мин',active:'Активно',km:'км',remaining:'осталось',passed:'прошло',allClear:'Спокойно',noAlerts:'Нет тревог',noResults:'Пусто',more:'Ещё',now:'Сейчас',todayL:'Сегодня',yesterdayL:'Вчера',weekAvg:'Средн.',ttsPrefix:'Красная тревога в ',unknownLoc:'Неизвестное место'}};
